...
LABEL \
    ...
    org.label-schema.description="go-parking" \
    org.label-schema.build-date=${BUILD_DATE} \
    org.label-schema.name="go-parking" \
    org.label-schema.schema-version="1.0" \
    org.label-schema.usage="https://gitlab.com/ad/go-parking/-/blob/master/README.md" \
    org.label-schema.vcs-ref=${BUILD_REF} \
    org.label-schema.vcs-url="https://github.com/ad/go-parking/" \
